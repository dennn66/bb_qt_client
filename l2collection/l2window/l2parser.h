...
#include "l2parser\l2window\objects\skillbar.h"
#include "l2parser\l2window\objects\mainbox.h"
#include "l2parser\l2window\objects\mobbox.h"
#include "l2parser\l2window\objects\petbox.h"
